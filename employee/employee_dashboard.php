                ...
                <div style="display: flex; flex-wrap: wrap;">
                  ...
                  <div class="profile-dashboard">
                    ...
                    <div class="profile-info">
                      ...
                      <div><span
                          class="name"><?php echo htmlspecialchars($employeeDetails['firstName'] . ' ' . $employeeDetails['lastName']); ?></span>
                      </div>
                      <div class="date"><?php echo date('F j, Y'); ?></div>
                      <a href="employee_profile.php" class="btn btn-danger edit-button">
                  ...
                  <div class="employee-details">
                    ...
                    <a href="employee_certificate.php" class="view-link">Click here to view</a>
                    <div class="line"></div>
