...
// Fetch certificates with employee details
$query = "SELECT ec.*, ud.firstName, ud.lastName 
          FROM employee_certificates ec
          JOIN user_details ud ON ec.employee_id = ud.ID
          ORDER BY ec.uploaded_date DESC";
$result = mysqli_query($conn, $query);
          ...
          <div class="main-container">
            ...
            <div class="table-responsive">
              <div class="container table-scontainer">
                ...
                <input type="text" id="search" class="form-control" placeholder="Search..." value="<?php echo htmlspecialchars($search_term); ?>" onkeydown="handleSearch(event)">
                ...
                <tr>
                    ...
                    <td>
                        <a href="../uploads/certificates/<?php echo htmlspecialchars($row['file_path']); ?>" target="_blank"><button class='view-button'><i class='fas fa-eye'></i></button></a>
                    </td>
                </tr>
                <?php endwhile; ?>
                  </tbody>
