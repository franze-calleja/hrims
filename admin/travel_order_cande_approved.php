        ...
        <div class="container-fluid page-content mt-3">
          ...
          <div class="main-container">
            ...
            <div class="leave-status-container">
              ...
              <a href="travel_order_cande_approved.php" class="btn leave-status active">Approved</a>
              <a href="travel_order_cande_declined.php" class="btn leave-status">Declined</a>
            </div>
            <div class="table-container">
              <div class="container table-scontainer">
                <h3 class="table-name">Approved Travel Order Candelaria Submissions</h3>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      travelOrderCModal.addEventListener('show.bs.modal', function (event) {
        ...
        viewFormButton.href = `hris-form/travel-order-form.php?travel_order_id=${travelOrderCId}`;
        console.log("View Form Button href:", viewFormButton.href); // Log the href to debug

        fetchLeaveDetails(travelOrderCId);
      });
    });
