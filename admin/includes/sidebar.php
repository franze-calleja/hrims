...
<div class="col-auto p-0 bg-dark" id="sidebar">
    <div class="d-flex flex-column align-items-center align-items-sm-start text-white min-vh-100">
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li>
                <a href="admin_dashboard.php" class="nav-link px-0 align-middle text-white">
                    <h8><i class="fas fa-tachometer-alt icon-size"></i> <span class="ms-1">Dashboard</span></h8>
                </a>
            </li>
            <li>
                <a href="admin_profile.php" class="nav-link px-0 align-middle text-white">
                    <h8><i class="fas fa-user-alt icon-size"></i> <span class="ms-1">Profile</span></h8>
                </a>
            </li>
            <li>
                <a href="employee_details.php" class="nav-link px-0 align-middle text-white">
                    <h8><i class="fas fa-users icon-size"></i> <span class="ms-1">Employee</span></h8>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="certificate.php" class="nav-link px-0 align-middle text-white">
                    <h8><i class="fas fa-certificate icon-size"></i> <span class="ms-1">Certificate</span></h8>
                </a>
            </li>
        </ul>
    </div>
