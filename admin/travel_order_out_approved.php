        ...
        <div class="container-fluid page-content mt-3">
          ...
          <div class="main-container">
            ...
            <div class="leave-status-container">
              <a href="travel_order_out_pending.php" class="btn leave-status">Pending</a>
              <a href="travel_order_out_approved.php" class="btn leave-status active">Approved</a>
              <a href="travel_order_out_declined.php" class="btn leave-status">Declined</a>
            </div>
            <div class="table-container">
              <div class="container table-scontainer">
                <h3 class="table-name">Approved Travel Order Submissions</h3>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      travelOrderModal.addEventListener('show.bs.modal', function (event) {
        ...
        viewFormButton.href = `hris-form/travel-order-form2.php?travel_order_id=${travelOrderId}`;
        console.log("View Form Button href:", viewFormButton.href); // Log the href to debug

        fetchLeaveDetails(travelOrderId);
      });
    });
  </script>
  <script>
