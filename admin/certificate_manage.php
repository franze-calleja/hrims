...
if ($employeeID) {
  ...
  header("Location: ../employee_list.php"); // Redirect to a list page or show an error
  exit;
}

// Fetch certificates for the specified employee
          ...
          <div class="card mb-4 bg-light">
            <div class="card-body">
              <div class="row align-items-center">
                ...
                <div class="col-auto">
                  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#uploadModal"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Pass the employee ID in the form action URL -->
                <form action="upload_certificate.php?id=<?php echo htmlspecialchars($employeeID); ?>" method="POST" enctype="multipart/form-data" id="certificateForm">
                    <!-- Hidden field to store the employee ID -->
                    <input type="hidden" name="employee_id" value="<?php echo htmlspecialchars($employeeID); ?>">

                    <!-- Form fields for certificate details -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="upload-dropzone" id="dropzone">
                            <input type="file" class="d-none" id="certificate_file" name="certificate_file" accept=".pdf,.jpg,.jpeg,.png" required>
                            <div class="text-center">
                                ...
                                <p class="text-muted small">Supported formats: PDF, JPG, PNG (Max. 5MB)</p>
                            </div>
                        </div>
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-primary" style="background-color: #800000 !important;">Upload Certificate</button>
                    </div>
                </form>
            </div>
        </div>
