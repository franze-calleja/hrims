        ...
        <div class="container-fluid page-content mt-3">
          ...
          <div class="main-container">
            ...
            <div class="leave-status-container">
              ...
              <a href="make_up_class_approved.php" class="btn leave-status active">Approved</a>
              <a href="make_up_class_declined.php" class="btn leave-status">Declined</a>
            </div>
            <div class="table-container">
              <div class="container table-scontainer">
                <h3 class="table-name">Declined Make-up Class Submissions</h3>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      makeUpClassModal.addEventListener('show.bs.modal', function (event) {
        ...
        viewFormButton.href = `hris-form/make-up-form.php?makeup_class_id=${makeUpClassId}`;
        console.log("View Form Button href:", viewFormButton.href); // Log the href to debug

        fetchLeaveDetails(makeUpClassId);
      });
    });
