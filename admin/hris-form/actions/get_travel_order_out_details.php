...
try {
    ...
    $sql = "SELECT tro.travel_order_id, ud.firstName, ud.lastName, tro.destination, tro.purpose, 
    tro.start_date, tro.return_date, tro.cash_advance, tro.report_date, tro.status, tro.dept_head_id, tro.dean_id,
...
LEFT JOIN user_details dh ON tro.dept_head_id = dh.ID
LEFT JOIN user_details dn ON tro.dean_id = dn.ID
WHERE tro.travel_order_id = '$travel_order_id'";
    ...
    error_log("Error in get_travel_order_out_details.php: " . $e->getMessage());
