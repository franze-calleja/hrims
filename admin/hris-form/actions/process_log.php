...
function checkAndUpdateMakeUpClassStatus($conn, $log_id) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($role) {
        case 'deptHead':
            $sql = "UPDATE log_form SET dept_head_approval = ? WHERE log_id = ?";
            break;
        case 'dean':
            $sql = "UPDATE log_form SET dean_approval = ? WHERE log_id = ?";
            break;
        case 'admin':
            $sql = "UPDATE log_form SET admin_approval = ? WHERE log_id = ?";
            break;
        default:
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $status_update = checkAndUpdateMakeUpClassStatus($conn, $log_id);
