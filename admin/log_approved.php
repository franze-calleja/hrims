        ...
        <div class="container-fluid page-content mt-3">
          ...
          <div class="main-container">
            ...
            <div class="leave-status-container">
              ...
              <a href="log_approved.php" class="btn leave-status active">Approved</a>
              <a href="log_declined.php" class="btn leave-status">Declined</a>
            </div>
            <div class="table-container">
              <div class="container table-scontainer">
                <h3 class="table-name">Approved Log Submissions</h3>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  logModal.addEventListener('show.bs.modal', function (event) {
    ...
    viewFormButton.href = `hris-form/logform.php?log_id=${logId}`;
    console.log("View Form Button href:", viewFormButton.href); // Log the href to debug

    fetchLeaveDetails(logId);
  });
});
