...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        // Insert into employee_credentials table
        $sqlCredentials = "INSERT INTO employee_credentials (ID, password) 
                           VALUES ('$employeeID', '$passwordHash')";
...
<body>
  <div class="register-container">
    ...
    <form id="registerForm" action="create_employee.php" method="POST">
