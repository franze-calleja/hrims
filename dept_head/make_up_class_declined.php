...
$sql = "SELECT mc.makeup_class_id, ud.firstName, ud.lastName, mc.subject, 
        ...
        mc.status, mc.decline_reason, mc.dept_head_id, mc.dean_id 
        FROM make_up_forms mc
        JOIN user_details ud ON mc.employee_id = ud.ID
        WHERE mc.status = 'Declined'
        AND (mc.dept_head_id = '$user_id' OR mc.dean_id = '$user_id')";
        ...
        <div class="container-fluid page-content mt-3">
          ...
          <div class="main-container">
            ...
            <div class="leave-status-container">
              <a href="make_up_class_pending.php" class="btn leave-status">Pending</a>
              <a href="make_up_class_approved.php" class="btn leave-status">Approved</a>
              <a href="make_up_class_declined.php" class="btn leave-status active">Declined</a>
            </div>
            <div class="table-container">
              <div class="container table-scontainer">
                <h3 class="table-name">Approved Make-up Class Submissions</h3>
