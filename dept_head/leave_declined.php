...
$sql = "SELECT lf.leave_id, ud.firstName, ud.lastName, lf.leave_type, 
        lf.start_date, lf.end_date, lf.place, lf.status, lf.decline_reason, lf.dept_head_id, lf.dean_id 
        FROM leave_forms lf
        JOIN user_details ud ON lf.employee_id = ud.ID
        WHERE lf.status = 'Declined'
        ...
        <div class="container-fluid page-content mt-3">
          ...
          <div class="main-container">
            ...
            <div class="leave-status-container">
              ...
              <a href="leave_declined.php" class="btn leave-status active">Declined</a>
            </div>
            <div class="table-container">
              <div class="container table-scontainer">
                <h3 class="table-name">Declined Leave Submissions</h3>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="#" id="CLose" class="btn btn-secondary">Close</a>
        </div>
      </div>
    </div>
  </div>
