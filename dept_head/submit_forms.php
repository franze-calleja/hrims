...
.modal-dialog-scrollable .modal-content {
    max-height: 85vh; /* Slightly less than dialog to account for header/footer */
}
            ...
            <form id="leaveForm" action="" method="POST">
              ...
              <div class="input-group">
                <div>
                  ...
                  <input type="text" id="empID" name="empID" placeholder="Employee ID" value="<?php echo htmlspecialchars($_SESSION['username']); ?>" readonly>
                </div>
                <div>
                ...
                <div>
                  <label for="deanReport">DeptHead Reporting to:</label>
            ...
            <form id="travelOrderForm" action="" method="POST">
              ...
              <div class="input-group">
                ...
                <div>
                  ...
                  <input type="date" id="travelReportDate" name="travelReportDate" placeholder="Report Date"
                    required>
                </div>
              </div>
              <div id="error" class="error"></div>
...
<!-- Make-Up Class Modal -->
<div class="modal fade" id="makeUpClassModal" tabindex="-1" aria-labelledby="makeUpClassModalLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <form id="makeUpClassForm" action="" method="POST">
            ...
            <div class="input-group">
              ...
              <div>
                ...
                <input type="text" id="makeupClassRoom" name="makeupClassRoom" placeholder="Make-up Class Room" required>
              </div>
              <div>
                <label for="reason">Reason</label>
